            ...
            while 1
                switch self.orderReady
                    ...
                    case 1
                        ...
                        for k = 1:4
                            self.animateRobot(self.robot.model, self.qMatrix{k}, cup{k}, cupMoving{k},person{k}, personMoving{k});
                        end
                        self.orderReady = 0;
                        self.startRobot = 0;
                        self.robotRunning = 0;
                    case 2
                        ...
                        disp("Order Number 2");
                        for l = 5:8
                            self.animateRobot(self.robot.model, self.qMatrix{l}, cup{l}, cupMoving{l},person{l}, personMoving{l});
                        end
                        self.orderReady = 0;
                        self.startRobot = 0;
                        self.robotRunning = 0;
                    case 3
                        ...
                        %animate the movement for each robot
                        for h = 1:4
                            self.animateRobot(self.robot.model, self.qMatrix{h}, cup{h}, cupMoving{h},person{3}, personMoving{h});
                            %     pause
                        end
                        self.orderReady = 0;
                        self.startRobot = 0;
