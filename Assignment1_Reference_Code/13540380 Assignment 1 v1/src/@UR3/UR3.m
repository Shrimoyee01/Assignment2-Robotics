classdef UR3 < handle
    ...
    methods%% Class for UR3 robot simulation
        function self = UR3(useGripper, xPosition, yPosition, zPosition, zYawAmount)
            if nargin < 1
                useGripper = false;
            end
        ...
        function [ReturnPosition] = UR3RobotLocation(self)
            %     if nargin < 1
            ...
            L2 = Link('d',0      ,'a',0.24365,'alpha',-pi,'offset',-pi/2,'qlim',[deg2rad(-90),deg2rad(90)]);
            L3 = Link('d',0      ,'a',0.21325,'alpha',pi,'offset',0,'qlim',[deg2rad(-170),deg2rad(170)]);
            ...
            self.model = SerialLink([L1 L2 L3 L4 L5 L6],'name','UR3');

            % Rotate robot to the correct orientation
            self.model.base = self.model.base * transl(self.xPos,self.yPos,self.zPos);
            self.model.base = self.model.base  * troty(self.zYaw);
